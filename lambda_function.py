...
def recommend_portfolio():
    ...
    if riskLevel = 'none':
        ...
        print("80% bonds (AGG), 20% equities (SPY)")
    elif riskLevel = 'low':
        ...
        print("0% bonds (AGG), 100% equities (SPY)")
        
        
    for age in range(65):
        if investmentAmount >= 5000:
            print("Welcome to your future investment")
        else:
            print("Your savings is below the recommended amount")
